...
final class ImageManager {
    ...
    */
    ...
    /**
   Method for to save image locally in docuement directory
    - Parameter image: Image to save
    - Parameter urlRequest: Image to save
    - Parameter completion: Completion returning saved image path if successfull
    */
